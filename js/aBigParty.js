...
function maker() {
    ...
    class bigParty {
        ...
        story() {
            console.log(`I remember when I was in high school a host a big ${this.adjectiveOne} party. The party theme was ${this.nounOne} themed. My best friend Tim nicknamed the ${this.nounTwo} invited as many of our friends as possible. The result of all these invites ment over 150 people turned up to this ${this.adjectiveTwo} parrty. It got crazy when one guess bought his pet ${this.nounThree} to the party.`)
            ...
            textBox.innerText = `I remember when I was in high school I hosted a big ${this.adjectiveOne} party. The party theme was ${this.nounOne} themed. My best friend Tim nicknamed the ${this.nounTwo} invited as many of our friends as possible. The result of all these invites ment over 150 people turned up to this ${this.adjectiveTwo} parrty. It got crazy when one guest bought his pet ${this.nounThree} to the party.`
    ...
    const inputBigParty = new bigParty(adjOne.value, nOne.value, nTwo.value, nThree.value, adjTwo.value);
    inputBigParty.story()
