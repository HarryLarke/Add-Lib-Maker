...
function maker() {
    ...
    class SnowyForest {
        ...
        story() {
            console.log(`I went on Holiday to Great Yarmouth known as the sea-side-town of ${this.nOne}. The sea is ${this.adjectiveOne} due to the it facing the North Sea. There are many attractions to visit in Yarmoth, including the ${this.nounTwo} museum. Additionally, there are the many arcades and amusement, which are very ${this.adjectiveTwo}! For me it is seeing ${this.nounThree} roaming around the town, is the reason why I visit Great Yarmouth for my holiday.`)
            ...
            textBox.innerText = `I went on Holiday to Great Yarmouth known as the sea-side-town of ${this.nounOne}. The sea is ${this.adjectiveOne} due to the it facing the North Sea. There are many attractions to visit in Yarmoth, including the ${this.nounTwo} museum. Additionally, there are the many arcades and amusement, which are very ${this.adjectiveTwo}! For me it is seeing ${this.nounThree} roaming around the town. That is why I visit Great Yarmouth for my holiday.`
