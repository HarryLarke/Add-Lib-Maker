...
function maker() {
    ...
    class newHobby {
        ...
        story() {
            console.log(`Two months ago I started a new ${this.adjectiveOne} hobby, Reel dancing. Now I am dancing all the time to ${this.nounOne} music. I dance to ${this.nounOne} music on the ${this.nounTwo} with my partner. The reason why I have fallen for Reeling is because of the ${this.adjectiveTwo} nature of Reeling. Now my commitment ad vigor has ment by club call be the ${this.nounThree} dancer. Because, I once danced with a ${this.nounThree}!`)
            ...
            textBox.innerText = `Two months ago I started a new ${this.adjectiveOne} hobby, Reel dancing. Now I am dancing all the time to ${this.nounOne} music. I dance to ${this.nounOne} music on ${this.nounTwo} with my partner. The reason why I have fallen for Reeling is because of the ${this.adjectiveTwo} nature of Reeling. Now my commitment and vigor has ment my club call me the ${this.nounThree} dancer. Because, I once danced with a ${this.nounThree}!`
    ...
    const inputNewHobby = new newHobby(adjOne.value, nOne.value, nTwo.value, nThree.value, adjTwo.value);
    inputNewHobby.story()
